			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item active"><a class="nav-link" href="{{route('homes.index')}}">Home</a></li>
						<li class="nav-item"><a class="nav-link" href="{{route('aboutus.index')}}">About Us</a></li>
						<li class="nav-item"><a class="nav-link" href="{{route('course.index')}}">Course</a></li>
					...
					<ul class="nav navbar-nav navbar-right">
                        <li><a class="hover-btn-new log orange" href="{{route('login')}}" data-toggle="modal" data-target="#login"><span>Login</span></a></li>
                    </ul>
					<ul class="nav navbar-nav navbar-right">
