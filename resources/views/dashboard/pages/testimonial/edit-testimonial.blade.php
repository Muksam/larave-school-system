								...
								<div class="card-body row">
                                   <div class="col-md-12">
									  ...
									  <div class="form-group form-group-sm">
										...
										<div class="form-group form-group-sm">
											<label >Details:</label>
											<textarea name="details" rows="7" cols="100" value="{{$testimonial->details}}" class="form-control"></textarea>
											<a href="" style="color: red;">{{$errors->first('details')}}</a>
										</div> 

										<div class="form-group form-group-sm">
											<label for="upload">Testimonial Image</label>
										...
										<div class="form-group form-group-sm">
											<button class="btn btn-success btn-sm"> Edit Testimonial
											</button>
                                        </div>	
                                    </div>
									  </form> 
