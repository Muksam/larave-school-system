								...
								<div class="card-body row">
                                   <div class="col-md-12">
									  ...
									  @csrf
									    ...
									    <div class="form-group form-group-sm">
												<label>Name:</label>
												<input type="text" name="course_name"  placeholder="Name" class="form-control">
                                        ...
                                        <div class="form-group form-group-sm">
												...
												<input type="text" name="no_of_student"  placeholder="Student Number" class="form-control">

												<a href="" style="color: red;">{{$errors->first('no_of_student')}}</a>
										</div>

										<div class="form-group form-group-sm">
											<button class="btn btn-success btn-sm"> Add Course
											</button>
                                        </div>		
                                    </div>
									  </form> 
